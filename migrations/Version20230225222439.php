 ...
 */
final class Version20230225222439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_post_like (posts_id INT NOT NULL, user_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', INDEX IDX_65D6AA5CD5E258C5 (posts_id), INDEX IDX_65D6AA5CA76ED395 (user_id), PRIMARY KEY(posts_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
